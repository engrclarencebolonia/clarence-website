  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(91,72,250,1) 1px, transparent 1px), linear-gradient(90deg, rgba(91,72,250,1) 1px, transparent 1px)",
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 w-full">
        <div className="flex flex-col lg:flex-row items-center lg:items-center gap-12 w-full">
          ...
          <motion.div
            ...
            className="order-first lg:order-last flex-shrink-0 lg:ml-auto relative"
          >
            <div className="relative w-52 h-52 sm:w-64 sm:h-64 rounded-3xl overflow-hidden border-2 border-brand-200 dark:border-brand-800/40 shadow-2xl shadow-brand-500/10">
              <Image
                src="/images/profile-2.png"
                alt="Clarence Gio Bolonia"
                fill
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <h1 className="text-display mb-2">
                <span className="block text-5xl sm:text-6xl md:text-7xl text-slate-900 dark:text-white">
                  Designing clarity
                </span>
                <span className="block text-5xl sm:text-6xl md:text-7xl">
                  <span className="gradient-text">from complexity.</span>
                </span>
              </h1>
            </motion.div>
            ...
            <motion.p
              ...
              className="mt-6 text-lg sm:text-xl text-slate-600 dark:text-slate-400 max-w-xl leading-relaxed font-body"
            >
              I&rsquo;m{" "}
              <span className="font-semibold text-slate-900 dark:text-white">
                Clarence Gio Bolonia
              </span>{" "}
              — a UI/UX & Product Designer with 4+ years building{" "}
              ...
              products. I design with engineering feasibility in mind.
            </motion.p>
            ...
            >
              {personalInfo.stats.map((stat) => (
                <div key={stat.label} className="flex flex-col">
                  <span className="text-2xl font-display font-bold text-brand-600 dark:text-brand-400 leading-none">
                    {stat.value}
                  </span>
            ...
            >
              <Link
                href="/#projects"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-600 text-white font-medium text-sm hover:bg-brand-700 shadow-lg shadow-brand-500/20 hover:shadow-brand-500/30 transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0"
              >
                View My Work
                <ArrowDown size={15} className="animate-float" />
              </Link>
              <a
                href={`mailto:${personalInfo.email}`}
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 font-medium text-sm hover:border-brand-400 dark:hover:border-brand-600 hover:text-brand-600 dark:hover:text-brand-400 transition-all duration-200 hover:-translate-y-0.5 bg-white dark:bg-surface-800"
              >
                Get in Touch
              </a>
            </motion.div>
      ...
      >
        ...
        <motion.div
          ...
          className="w-4 h-6 rounded-full border border-slate-300 dark:border-white/10 flex items-start justify-center pt-1"
          aria-hidden
        >
